...
const manifest = {
  ...
  githubRelease: 'https://github.com/rainhuang0220/PlainList/releases/tag/v2.5.1',
  artifacts: [
    {
      platform: 'macos',
      arch: 'arm64',
      filename: 'PlainList-2.5.1-macos-arm64.dmg',
      url: 'https://github.com/rainhuang0220/PlainList/releases/download/v2.5.1/PlainList-2.5.1-macos-arm64.dmg',
      mirrorUrl: '/downloads/PlainList-2.5.1-macos-arm64.dmg',
      sha256: 'a'.repeat(64),
      size: 1,
    },
    {
      platform: 'macos',
      arch: 'x64',
      filename: 'PlainList-2.5.1-macos-x64.dmg',
      url: 'https://github.com/rainhuang0220/PlainList/releases/download/v2.5.1/PlainList-2.5.1-macos-x64.dmg',
      mirrorUrl: '/downloads/PlainList-2.5.1-macos-x64.dmg',
      sha256: 'b'.repeat(64),
      size: 1,
    },
    {
      platform: 'android',
      arch: 'universal',
      filename: 'PlainList-2.5.1-android.apk',
      url: 'https://github.com/rainhuang0220/PlainList/releases/download/v2.5.1/PlainList-2.5.1-android.apk',
      mirrorUrl: '/downloads/PlainList-2.5.1-android.apk',
      sha256: 'c'.repeat(64),
      size: 1,
    },
  ],
...
try {
  for (const viewport of viewports) {
    for (const agent of agents) {
      ...
      if (!snapshot.version.includes('v2.5.1')) sceneFail.push('version');
